...
class Me:
    ...
    def __init__(self):
        ...
        self.name = "Lev Zhitnik"
        reader = PdfReader("me/lev-linkedin.pdf")
        self.linkedin = ""
    ...
    def system_prompt(self):
        system_prompt = f"""You are acting as {self.name}. You are answering questions on {self.name}'s website, particularly questions related to {self.name}'s career, background, skills and experience.
